...
unsigned char data[27]={0x7e,0x94,0x38,0xcc,0xed,0xc5,0x8a,0x79,0xf6,0x9e,0x1c,0x8a,0x6d,0xb1,0xd5,0x76,0xbe,0xb5,0xdd,0xe4,0xb1,0xc2,0xa4,0x9b,0xb5,0x69,0x81};
...
void main()
{
    printf("the result is %d",DecryptAesGCM(data))
}